...
/*
   ...
   */
   ...
   while(1){
	   CanPollEcho(XPAR_PS7_CAN_0_DEVICE_ID);
   }
 ...
 */

   {
      ...
      print("\r\n Running CanPsPolledExample() for ps7_can_1...\r\n");

      Status = CanPsPolledExample(XPAR_PS7_CAN_1_DEVICE_ID);
   ...
   /*
   {
      ...
      print("\r\n Running Interrupt Test  for ps7_can_1...\r\n");

      Status = CanPsIntrExample(&intc, &ps7_can_1, \
