...
################################################################
# This is a generated script based on design: dsgn_can_network_v3
#
...
# source dsgn_can_network_v3_script.tcl
...
set design_name dsgn_can_network_v3
...
proc create_root_design { parentCell } {
  ...
  set gpio_in_intr [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 gpio_in_intr ]
...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  # Create instance: axi_gpio_in_intr, and set properties
  set axi_gpio_in_intr [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_in_intr ]
  set_property -dict [ list \
...
CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#GPIO#CAN 0#CAN 0#CAN 1#CAN 1#GPIO#GPIO#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#USB Reset#SD 0#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0} \
CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#rx#tx#tx#rx#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
...
CONFIG.PCW_EN_CAN1.VALUE_SRC {DEFAULT} \
...
CONFIG.NUM_MI {3} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports gpio_in_intr] [get_bd_intf_pins axi_gpio_in_intr/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO1 [get_bd_intf_ports btns_4bits] [get_bd_intf_pins axi_gpio_btns/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports leds_4bits] [get_bd_intf_pins axi_gpio_leds/GPIO]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins processing_system7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins axi_gpio_in_intr/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins axi_gpio_btns/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins axi_gpio_leds/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI]

  # Create port connections
  connect_bd_net -net axi_gpio_btns_ip2intc_irpt [get_bd_pins axi_gpio_btns/ip2intc_irpt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_gpio_in_intr_ip2intc_irpt [get_bd_pins axi_gpio_in_intr/ip2intc_irpt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_btns/s_axi_aclk] [get_bd_pins axi_gpio_in_intr/s_axi_aclk] [get_bd_pins axi_gpio_leds/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_btns/s_axi_aresetn] [get_bd_pins axi_gpio_in_intr/s_axi_aresetn] [get_bd_pins axi_gpio_leds/s_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_in_intr/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_btns/S_AXI/Reg] SEG_axi_gpio_0_Reg1
  create_bd_addr_seg -range 0x00010000 -offset 0x41220000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_leds/S_AXI/Reg] SEG_axi_gpio_0_Reg2
...
preplace port gpio_in_intr -pg 1 -y -470 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 3 -y -180 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 1 -y -140 -defaultsOSRD
preplace inst axi_gpio_leds -pg 1 -lvl 1 -y -700 -defaultsOSRD
preplace inst axi_gpio_in_intr -pg 1 -lvl 1 -y -420 -defaultsOSRD
preplace inst axi_gpio_btns -pg 1 -lvl 1 -y -570 -defaultsOSRD
...
preplace netloc processing_system7_0_DDR 1 2 3 NJ -280 NJ -280 NJ
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 0 5 NJ -800 NJ -800 NJ -800 NJ -800 1570
preplace netloc processing_system7_0_M_AXI_GP0 1 2 2 870 -550 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 2 1 900
preplace netloc processing_system7_0_axi_periph_M02_AXI 1 0 5 NJ -770 NJ -770 NJ -770 NJ -770 1550
preplace netloc axi_gpio_btns_ip2intc_irpt 1 0 2 10 -490 420
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 0 4 NJ -500 NJ -500 NJ -500 1250
preplace netloc axi_gpio_0_GPIO1 1 1 4 NJ -640 NJ -640 NJ -640 NJ
preplace netloc xlconcat_0_dout 1 1 1 420
preplace netloc axi_gpio_0_GPIO2 1 1 4 NJ -700 NJ -700 NJ -700 NJ
preplace netloc processing_system7_0_FIXED_IO 1 2 3 NJ -270 NJ -270 NJ
preplace netloc axi_gpio_0_GPIO 1 1 4 430 -610 NJ -610 NJ -610 NJ
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 3 1 1260
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 0 -320 430 -320 890 -370 1270
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 0 5 NJ -790 NJ -790 NJ -790 NJ -790 1560
preplace netloc axi_gpio_in_intr_ip2intc_irpt 1 0 2 20 -350 420
levelinfo -pg 1 -30 310 670 1080 1410 1650 -top -810 -bot 180
",
}
