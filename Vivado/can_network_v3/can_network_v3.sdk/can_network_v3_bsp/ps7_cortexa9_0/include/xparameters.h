...
#define XPAR_AXI_GPIO_BTNS_BASEADDR 0x41210000
#define XPAR_AXI_GPIO_BTNS_HIGHADDR 0x4121FFFF
#define XPAR_AXI_GPIO_BTNS_DEVICE_ID 0
#define XPAR_AXI_GPIO_BTNS_INTERRUPT_PRESENT 1
#define XPAR_AXI_GPIO_BTNS_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_IN_INTR */
#define XPAR_AXI_GPIO_IN_INTR_BASEADDR 0x41200000
#define XPAR_AXI_GPIO_IN_INTR_HIGHADDR 0x4120FFFF
#define XPAR_AXI_GPIO_IN_INTR_DEVICE_ID 1
#define XPAR_AXI_GPIO_IN_INTR_INTERRUPT_PRESENT 1
#define XPAR_AXI_GPIO_IN_INTR_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_LEDS */
#define XPAR_AXI_GPIO_LEDS_BASEADDR 0x41220000
#define XPAR_AXI_GPIO_LEDS_HIGHADDR 0x4122FFFF
...
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXI_GPIO_BTNS_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 1
#define XPAR_GPIO_0_IS_DUAL 0

/* Canonical definitions for peripheral AXI_GPIO_IN_INTR */
#define XPAR_GPIO_1_BASEADDR 0x41200000
#define XPAR_GPIO_1_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_AXI_GPIO_IN_INTR_DEVICE_ID
...
#define XPAR_FABRIC_AXI_GPIO_IN_INTR_IP2INTC_IRPT_INTR 61
#define XPAR_FABRIC_AXI_GPIO_BTNS_IP2INTC_IRPT_INTR 62
