...
HD_PWD='/home/catalin/M.E.Electronics/Project_2/SEM2PRO/Vivado/can_network_v3/can_network_v3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dsgn_can_network_v3_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source dsgn_can_network_v3_wrapper.tcl -notrace
