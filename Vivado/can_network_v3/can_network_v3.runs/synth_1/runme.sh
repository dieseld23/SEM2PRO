...
HD_PWD='/home/catalin/M.E.Electronics/Project_2/SEM2PRO/Vivado/can_network_v3/can_network_v3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dsgn_can_network_v3_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source dsgn_can_network_v3_wrapper.tcl
