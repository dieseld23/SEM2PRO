...
################################################################
# This is a generated script based on design: design_transmitter
#
...
# source design_transmitter_script.tcl
...
set design_name design_transmitter
...
CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#rx#tx#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
...
CONFIG.NUM_MI {2} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins axi_gpio_btns/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins axi_gpio_leds/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net axi_gpio_btns_ip2intc_irpt [get_bd_pins axi_gpio_btns/ip2intc_irpt] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_btns/s_axi_aclk] [get_bd_pins axi_gpio_leds/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_btns/s_axi_aresetn] [get_bd_pins axi_gpio_leds/s_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
...
#  -string -flagsOSRD
preplace port btns_4bits -pg 1 -y -470 -defaultsOSRD
preplace port DDR -pg 1 -y -250 -defaultsOSRD
preplace port leds_4bits -pg 1 -y -640 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y -230 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 3 -y -180 -defaultsOSRD
preplace inst axi_gpio_leds -pg 1 -lvl 1 -y -640 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 4 -y -450 -defaultsOSRD
preplace inst axi_gpio_btns -pg 1 -lvl 1 -y -470 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 2 -y -160 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 2 3 NJ -90 NJ -250 NJ
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 0 5 20 -310 NJ -310 NJ -300 NJ -300 1390
preplace netloc processing_system7_0_M_AXI_GP0 1 2 2 NJ -530 N
preplace netloc processing_system7_0_FCLK_RESET0_N 1 2 1 700
preplace netloc axi_gpio_btns_ip2intc_irpt 1 1 1 250
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 0 4 30 -400 NJ -400 NJ -400 1050
preplace netloc processing_system7_0_FIXED_IO 1 2 3 NJ -80 NJ -230 NJ
preplace netloc axi_gpio_0_GPIO 1 1 4 N -480 NJ -480 NJ -310 NJ
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 3 1 1040
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 10 -380 260 -380 680 -390 1070
preplace netloc axi_gpio_1_GPIO 1 1 4 NJ -640 NJ -640 NJ -640 NJ
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 0 5 0 -300 NJ -300 NJ -290 NJ -290 1380
levelinfo -pg 1 -20 140 460 870 1230 1650 -top -710 -bot 180
",
}
