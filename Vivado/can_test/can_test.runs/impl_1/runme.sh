...
HD_PWD='/home/catalin/M.E.Electronics/Project_2_MyFiles/can_test/can_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_transmitter_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source design_transmitter_wrapper.tcl -notrace
