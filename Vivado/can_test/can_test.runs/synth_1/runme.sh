...
HD_PWD='/home/catalin/M.E.Electronics/Project_2_MyFiles/can_test/can_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_transmitter_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source design_transmitter_wrapper.tcl
