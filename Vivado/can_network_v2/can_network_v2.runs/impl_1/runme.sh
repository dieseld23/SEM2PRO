...
HD_PWD='/home/catalin/M.E.Electronics/Project_2/SEM2PRO/Vivado/can_network_v2/can_network_v2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dsgn_can_test_intr_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source dsgn_can_test_intr_wrapper.tcl -notrace
