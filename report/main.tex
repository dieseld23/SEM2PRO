...
\newcommand{\mikkel}[1]{\todo[inline,color=red!70, author = Mikkel]{#1}}
\newcommand{\martin}[1]{\todo[inline,color=blue!30, author = Martin]{#1}}
\newcommand{\thomas}[1]{\todo[inline,color=grey!30, author = Thomas]{#1}}
...
%\input{sections/Datalogging_requirements}
%\input{sections/localnetwork_requirements}
\newpage
