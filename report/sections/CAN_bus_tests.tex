...
\catalin{Restructure so there is a block with a short introduction, the test itself, and a conclusion}
...
\end{figure}
\martin{Define the colors on figure~\ref{fig:CAN_test1_raw}.}
