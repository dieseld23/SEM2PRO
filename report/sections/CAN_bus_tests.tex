...
The purpose of these tests is to show that the transceivers work, and that the bus does indeed transmit the correct message. 
...
\mikkel{Should these paragraph be made into something else? maybe list? Catalin:Are you satisfied now!?}
\begin{itemize}
