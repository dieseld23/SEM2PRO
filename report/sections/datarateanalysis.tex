...
Determining which architecture is most suitable for the system depends heavily on the amount of data that it has to support.
...
It is is a 9-axis sensor that provides data at a rate up to 400 Hz at 32 bit floating point precision.
