...
The three first points describe a flow which is presented in more detail on the flow diagram in figure \ref{fig:filter_1}.
...
\end{figure}
\martin{In figure~\ref{fig:state_machine}, the "boolean" value run, should be the same as the boolean value "running" in figure~\ref{fig:node_class_diagram}.}
...
\thomas{texttttt the above sections}