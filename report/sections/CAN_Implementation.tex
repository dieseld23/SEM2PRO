...
The first one is the physical CAN network that was proved functional using bare\-metal code programmed using the JTAG mode \catalin{is this well expressed, JTAG mode?} \martin{I think bare metal by it self is descriptive enough} on the Zybo board in the section \ref{sub:TestingCANStack_BareMetal}.
