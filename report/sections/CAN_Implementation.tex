...
\mikkel{move axi can to analysis. move assymetric multiprocesssing to future work. move bare metal first, split from linux part.}
...
\catalin{Move ip core to analysis}
