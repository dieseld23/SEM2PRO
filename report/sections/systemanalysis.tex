...
The wireless data connection between the go-kart and the stationary computer will be handled using WiFi.\catalin{had or has?}
The SD card with Linux mounted in each Zybo had sufficient free storage for logging data at a high rate.
...
\mikkel{Remember to refer to the big figure and change its caption!}
