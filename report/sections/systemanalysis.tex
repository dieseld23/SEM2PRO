...
\martin{I wrote it out a bit, I hope it's more understandable (this and the CAN bus above). Also moved the part where it says, we made our own PCB.}
...
\begin{figure}[h]
	...
	\label{fig:setup_ui}
\end{figure}
\mikkel{Change figure to what we talked about, Thomas.}
