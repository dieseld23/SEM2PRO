...
\item Software on stationary computer. It should be be analysed how the software on stationary should present the transferred data to the user in an UI.
\end{itemize}
...
\input{sections/power_requirements}
