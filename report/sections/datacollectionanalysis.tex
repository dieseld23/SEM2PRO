...
\martin{which five types? Can all the bullet point in section~\ref{sec:parameters} be measured with just five types? gps, imu, encoder, sevcon, thermometer. 5 types, not literally 5.}
