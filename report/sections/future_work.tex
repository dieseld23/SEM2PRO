...
As the final implementation might be done in PL, it is possible to utilize the 8 Mb/s there is nothing preventing the controller working at 8 Mb/s -- the FPGA can easily produce and interpret signals up to or beyond 8 Mb/s.
