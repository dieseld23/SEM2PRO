...
With further modifications and the addition of extra functionalities such as reading button input and writing the output to the LEDs, the developed final code was suitable to test the communication between two nodes on the CAN network.
\\\\
