...
According to TI itself\cite{3.3V_CAN}, this family of $3.3 \si{\volt}$ transceivers are compatible and interoperable with other \si{5 \volt} transceivers, so long as they support the same standard.\\
...
\martin{I think thes whole section belongs in the verification part.}
