...
\martin{For the most part there has been written node ID, message ID and message type. Abbreviate message?}
...
\end{figure}
\thomas{Changes to figure \ref{fig:backendclass}: all class names with small letters, backend should be called frontend}
