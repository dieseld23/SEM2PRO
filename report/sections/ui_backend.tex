...
\end{figure}
\thomas{DONE in class diagram: Changes to figure \ref{fig:backendclass}: all class names with small letters, backend should be called frontend, also figure~\ref{fig:backendconcept}}
