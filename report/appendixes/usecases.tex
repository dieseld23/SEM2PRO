...
\multicolumn{2}{|c|}{\textbf{Alternative flow of events}}                                   \\
\multicolumn{2}{|p{12 cm}|}{Any line: If connection is lost the system should detect it and mark the transferred log file as invalid}              \\ \hline                                                                                                                                    
\end{tabular}
\end{table}
...
\mikkel{Changed them! It is hard to do it nice, but I think it is okay.}
\begin{table}[H]
	\centering
	...
	\begin{tabular}{| r | p{7 cm} |}
		...
		\textbf{Special requirements:}            & -                                               \\ \hline 
		\multicolumn{1}{|c|}{\textbf{Actor action}} & \multicolumn{1}{c|}{\textbf{System response}}\\
		\multicolumn{1}{|p{5 cm} |}{\begin{tabular}[c]{@{}p{5cm}@{}}1. A new node is added by a developer.\end{tabular}}       	       &         \\ \hline
		\multicolumn{2}{|c|}{\textbf{Alternative flow of events}}                                   \\
		\multicolumn{2}{|p{12 cm}|}{-}              \\ \hline                                                                                                                                   
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{| r | p{7 cm} |}
		...
		\textbf{Special requirements:}            & -                                               \\ \hline 
		\multicolumn{1}{|c|}{\textbf{Actor action}} & \multicolumn{1}{c|}{\textbf{System response}}\\
		\multicolumn{1}{|p{5 cm} |}{1. Develop a GUI for the system.}       & 2. System runs as usual, but with the new GUI                               	                \\ \hline
		\multicolumn{2}{|c|}{\textbf{Alternative flow of events}}                                   \\
		\multicolumn{2}{|p{12 cm}|}{-}              \\ \hline                                                                                                                                   
	\end{tabular}
\end{table}