...
\mikkel{Have a look at these next two narratives}
\begin{table}[H]
	\centering
...
\begin{table}[H]
	...
	\begin{tabular}{| r | p{7 cm} |}
		...
		\textbf{Special requirements:}            & -                                               \\ \hline 
		\multicolumn{1}{|c|}{\textbf{Actor action}} & \multicolumn{1}{c|}{\textbf{System response}}\\
		\multicolumn{1}{|p{5 cm} |}{1. Develop a GUI for the system.}       & 2. System runs as usual, but with new beautiful GUI                               	                \\ \hline
		\multicolumn{2}{|c|}{\textbf{Alternative flow of events}}                                   \\
		\multicolumn{2}{|p{12 cm}|}{-}              \\ \hline                                                                                                                                   
	\end{tabular}
\end{table}